    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center mb-16">
        <div className="animate-fade-up inline-flex items-center gap-2 bg-[#DA4E24]/10 border border-[#DA4E24]/20 rounded-full px-4 py-1.5 mb-6">
          ...
          <span className="text-[#DA4E24] text-sm font-medium">System Architecture</span>
        </div>
      ...
      <div className="mt-24 relative">
        ...
        <div className="relative bg-[#0a0a0a] border border-[#1a1a1a] rounded-3xl p-8 sm:p-14 text-center">
          <div className="text-[#999] text-sm font-mono uppercase tracking-widest mb-10">The cost difference</div>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-14">
            <div>
              <div className="text-xs text-[#666] uppercase tracking-wider mb-2">Traditional team</div>
              <div className="text-6xl sm:text-8xl font-black text-[#555] line-through decoration-red-500/60 decoration-4">
                $20,000
              </div>
              <div className="text-[#666] text-lg mt-1 font-mono">/month</div>
            </div>

            <div className="flex flex-col items-center gap-3">
              <div className="hidden sm:flex flex-col items-center gap-1">
                <div className="w-px h-8 bg-gradient-to-b from-transparent to-[#DA4E24]/50" />
                ...
                <div className="w-px h-8 bg-gradient-to-b from-[#DA4E24]/50 to-transparent" />
              </div>
              <div className="sm:hidden text-3xl text-[#DA4E24]/60">↓</div>
            </div>

            <div>
              <div className="text-xs text-[#999] uppercase tracking-wider mb-2">With Ultron</div>
              <div className="text-6xl sm:text-8xl font-black" style={{ color: "#E8541A", textShadow: "0 0 60px rgba(232,84,26,0.3)" }}>
                $19
              </div>
              <div className="text-[#999] text-lg mt-1 font-mono">/month</div>
            </div>
          </div>
      ...
      {/* How agents connect */}
      <div className="mt-16 bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-8">
        <h2 className="text-xl font-bold mb-6">How the agents work together</h2>
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            {
              from: "CORTEX",
              fromColor: "text-[#DA4E24]",
              to: "SPECTER",
              toColor: "text-[#DA4E24]",
            ...
            <div key={i} className="flex gap-3 p-4 bg-black rounded-xl border border-[#1a1a1a]">
              <div className="flex-shrink-0 w-1 rounded-full bg-gradient-to-b from-[#DA4E24] to-[#F59E0B] mt-1" />
              <div>
                ...
                <p className="text-sm text-[#999]">{link.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="mt-16">
        ...
        <p className="text-[#999] text-center mb-8 text-sm">Every agent depends on every other agent. Remove one and the system degrades.</p>
        <div className="space-y-3">
          {[
            {
              agent: "CORTEX",
              agentColor: "text-[#DA4E24]",
            ...
            <div key={item.agent} className="flex gap-4 p-5 bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl hover:border-[#222] transition-colors">
              <div className="flex-shrink-0">
                <div className={`font-mono font-bold text-xs ${item.agentColor} bg-black border border-[#1a1a1a] rounded px-2 py-1`}>
                  {item.missing}
                </div>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm text-white mb-1.5">{item.consequence}</p>
                <p className="text-xs text-[#999]/70 font-mono">{item.impact}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="mt-16 grid sm:grid-cols-2 gap-4">
        ...
        <Link href="/calculator" className="group flex items-center justify-between gap-3 p-5 bg-[#0a0a0a] border border-[#1a1a1a] hover:border-[#222] rounded-2xl transition-all duration-200">
          <div>
            <div className="text-xs text-[#666] mb-1 font-mono">ALSO USEFUL</div>
            <div className="font-semibold text-white text-sm">Calculate your savings</div>
            <div className="text-xs text-[#999] mt-0.5">AI Team ROI Calculator</div>
          </div>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#555] group-hover:text-[#DA4E24] flex-shrink-0 transition-colors">
            <path d="M5 12h14M12 5l7 7-7 7"/>
          </svg>
