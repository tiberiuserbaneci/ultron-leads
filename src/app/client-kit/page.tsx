      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-24 pb-20">
        ...
        >
          <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl p-6 sm:p-8 text-center">
            ...
            <Link
              href="/rfp"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-[13px] font-semibold text-white border border-[#DA4E24] hover:bg-[#DA4E24]/10 transition-all"
            >
