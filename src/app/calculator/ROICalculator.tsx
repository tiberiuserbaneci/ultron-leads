        ...
        <div className="lg:col-span-2 bg-[#111111] border border-[#262626] rounded-2xl p-6 space-y-6">
          ...
          <div className="border-t border-[#1a1a1a] pt-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label className="text-sm text-neutral-300 block mb-2">Monthly freelancer/contractor spend</label>
                <div className="relative">
              ...
              <div>
                <label className="text-sm text-neutral-300 block mb-2">Monthly SaaS tools spend</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500 text-sm">$</span>
                  <input
                    type="number"
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#1a0a0a] border border-red-900/30 rounded-2xl p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-neutral-500">Monthly external costs</span>
              ...
              <div className="border-t border-red-900/30 pt-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-red-400 font-bold font-mono text-lg">{formatCurrency(Math.round(totalMonthlyCost))}</span>
                </div>
                <div className="flex justify-between mt-1">
                  <span className="text-xs text-neutral-600">Annual total</span>
                  <span className="text-red-400/70 font-mono text-sm">{formatCurrency(Math.round(totalAnnualCost))}/yr</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0a1a0a] border border-emerald-900/30 rounded-2xl p-6">
            <div className="text-sm font-medium text-emerald-400 mb-4">With Ultron</div>
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                <span className="text-neutral-500">Hours/week on operations</span>
